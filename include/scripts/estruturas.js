    ...
    if (lado === 'E') {
        ...
        if (No.no_esquerda === null) {
            if (No.no_direita === null) {
                ...
                svg_Substituir_No(No.no_direita, No, true);
                No = No.no_direita;
            }
        }
        else {
            if (No.no_direita === null) {
                svg_Substituir_No(No.no_esquerda, No, true);
                No = No.no_esquerda;
            }
            else {
                noIt = No.no_esquerda;
                if (noIt.no_direita === null) {
                    svg_Substituir_No(noIt, No, true);
                    noIt.no_direita = No.no_direita;
                    No = noIt;                    
                }
                else {
                    while (noIt.no_direita.no_direita !== null) {
                    ...
                    novoNo = noIt.no_direita;
                    svg_Substituir_No(novoNo, No, false);
                    svg_Substituir_No(novoNo.no_esquerda, novoNo, false);
                    noIt.no_direita = novoNo.no_esquerda;
                    svg_removeSvgs(noIt, false);                    
                    novoNo.no_esquerda = No.no_esquerda;
                    novoNo.no_direita = No.no_direita;
                    No = novoNo;                    
                    e_graficosNo(noIt, false);
                }
            }
